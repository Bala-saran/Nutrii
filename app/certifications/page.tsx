...
export default function CertificationsPage() {
  ...
  const certTypes = ["FSSAI", "ISO", "NABL", "Lab", "Organic"]
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 border-t border-white/10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card className="border-white/10 bg-white/5">
            ...
            <CardContent>
              <p className="text-muted-foreground">
                All products undergo rigorous testing for contaminants, allergens, and harmful substances to ensure
                consumer safety.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="border-white/10 bg-white/5">
            ...
            <CardContent>
              <p className="text-muted-foreground">
                International standards certification guarantees consistent quality across every batch and production
                run.
              </p>
            </CardContent>
          </Card>
