    ...
    <footer className="bg-[#1a1a1a] text-white border-t border-white/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Brand */}
          <div>
            <h3 className="font-bold text-xl text-[#D4AF37] mb-4">Nutritham Private Limited</h3>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-400">
              <li className="flex gap-2">
                ...
                <a href="mailto:nutritham@gmail.com" className="hover:text-[#D4AF37] transition">
                  nutritham@gmail.com
                </a>
              </li>
              <li className="flex gap-2">
                <Phone className="w-4 h-4 flex-shrink-0" />
                <a href="tel:+919944975570" className="hover:text-[#D4AF37] transition">
                  +91 99449 75570
                </a>
              </li>
              <li className="flex gap-2 items-start">
                <MapPin className="w-4 h-4 flex-shrink-0 mt-1" />
                <span>2-295, Kottamettupatti Post, Near Dall Mill, Omalur Taluk, Salem 636455</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-white/10 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex gap-4 mt-4 md:mt-0">
            ...
            <a
              href="https://www.instagram.com/nutritham_private_limited?utm_source=qr&igsh=MTJwZjlud2hwZzM5Zg=="
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-400 hover:text-[#D4AF37] transition"
